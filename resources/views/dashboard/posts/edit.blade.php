...
<div class="row mb-5">
    <div class="col-lg-8">
        <form method="POST" action="{{ url('/dashboard/posts/' . $post->slug) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!-- Menandakan bahwa ini adalah permintaan PUT -->
            ...
            <div class="mb-3">
                ...
                <img id="image-preview" src="{{ asset('storage/' . $post->img) }}" alt="Image Preview" class="mt-2"
            ...
            <div class="mb-3">
                ...
                <input id="context" type="hidden" name="context" value="{{ old('context', $post->context) }}">
            ...
            <button type="button" class="btn btn-secondary"
                onclick="window.location.href='/dashboard/posts'">Back</button>
